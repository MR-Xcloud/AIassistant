"""
Precise voice assistant that provides highly relevant answers to specific questions.
This version uses an improved RAG approach for better answer quality.
"""

import os
import time
import azure.cognitiveservices.speech as speechsdk
from precise_rag import PreciseRAG, load_precise_rag
...
class PreciseVoiceAssistant:
    def __init__(self):
        """Initialize the voice assistant"""
        print("Initializing Precise Voice Assistant...")
        self.speech_config = self._configure_speech_service()
        
        # Load data and initialize RAG
        self.texts = self._load_data()
        self.rag_engine = load_precise_rag(self.texts)
    ...
    def run(self):
        ...
        try:
            ...
            english_welcome = "Hello! I'm your precise voice assistant. I'll provide relevant answers to your specific questions."
            hindi_welcome = "नमस्ते! मैं आपका सटीक वॉइस असिस्टेंट हूँ। मैं आपके विशिष्ट प्रश्नों के प्रासंगिक उत्तर दूंगा।"
            ...
            while True:
                ...
                print("Processing your question with precise RAG...")
                english_response = self.rag_engine.answer_question(user_input)
...
def main():
    """Main function to run the precise voice assistant"""
    print("=" * 50)
    print("Precise Voice Assistant")
    print("=" * 50)
    
    assistant = PreciseVoiceAssistant()
    assistant.run()
