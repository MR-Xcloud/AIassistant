"""
Voice assistant with RAG (Retrieval-Augmented Generation) using Groq.
This version uses RAG with Groq for better answer generation.
"""

import os
import time
import azure.cognitiveservices.speech as speechsdk
from improved_chatbot_with_rag import get_answer, load_data
...
class RAGVoiceAssistant:
    def __init__(self):
        ...
        print("Initializing Voice Assistant with RAG and Groq...")
        self.speech_config = self._configure_speech_service()
        
        # Pre-load data for faster responses
        print("Loading knowledge base and initializing RAG engine...")
        load_data()
    ...
    def process_command(self, text):
        ...
        if text_lower in ["help", "what can you do", "commands"]:
            help_text = (
                "I can answer questions based on the website data using RAG with Groq. "
    ...
    def run(self):
        ...
        try:
            # Welcome message
            welcome_message = "Hello! I'm your voice assistant powered by RAG with Groq. How can I help you today?"
            ...
            while True:
                ...
                print("Processing your question with RAG and Groq...")
...
def main():
    ...
    print("=" * 50)
    print("Voice Assistant with RAG and Groq")
    print("=" * 50)
