"""
Improved chatbot with better answer generation.
This module enhances the original chatbot with direct answers for specific questions.
"""
...
def get_answer(query, top_k=3):
    """Get answer for a query using direct answers or semantic search"""
    # First try to get a direct answer
    direct_answer = get_direct_answer(query)
    if direct_answer:
        return direct_answer
    
    # If no direct answer, fall back to semantic search
