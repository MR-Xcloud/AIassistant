"""
Knowledge base with predefined answers for common questions.
This provides direct answers to specific questions that might not be
properly extracted from the website data.
"""

# Dictionary of predefined answers for specific questions
PREDEFINED_ANSWERS = {
    # CEO and leadership
...
def get_predefined_answer(query):
    ...
    Returns:
        str or None: The predefined answer if available, None otherwise
    """
    if not query:
        return None
