"""
Direct answers module for specific questions.
This provides hardcoded answers for common questions about the company.
"""

# Dictionary of direct answers for specific questions
DIRECT_ANSWERS = {
    # CEO and leadership
...
def get_direct_answer(query):
    """
    Check if there's a direct answer for the query.
    
    Args:
        query (str): The user's question
        
    Returns:
        str or None: The direct answer if available, None otherwise
    """
    if not query:
        return None
    ...
    # Direct match
    if clean_query in DIRECT_ANSWERS:
        return DIRECT_ANSWERS[clean_query]
